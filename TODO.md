...
- Measure delivery/formatting improvements separately from model/backend latency. Historical baseline results remain in docs/PLAY-LOOP-EXPERIMENT.md and run-local records.
